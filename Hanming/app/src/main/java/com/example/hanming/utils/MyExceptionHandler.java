...
public class MyExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    private static final String FILE_PATH = "/Compare";
    ...
    private final String logFilePath = Environment.getExternalStorageDirectory().getAbsolutePath() + FILE_PATH + File.separator + "crashLog";
